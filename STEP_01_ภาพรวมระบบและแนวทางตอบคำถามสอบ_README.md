...
> ### 📖 แนะนำลำดับขั้นตอนการอ่านทำความเข้าใจระบบ (Reading Guide Step-by-Step)
> เพื่อให้เข้าใจระบบอย่างเป็นลำดับขั้นตอนสำหรับเตรียมสอบและนำเสนอโครงงาน ให้เปิดอ่านตามไฟล์ดังต่อไปนี้:
> 1. [**STEP_01: ภาพรวมระบบและแนวทางตอบคำถามสอบ (Overview & Defense Q&A)**](STEP_01_ภาพรวมระบบและแนวทางตอบคำถามสอบ_README.md) — สรุปสถาปัตยกรรม ERD, 3NF, สรุป 3-Tier และแนวทางตอบคำถามสอบ
> 2. [**STEP_02: เล่มรายงานโครงงานฐานข้อมูลฉบับสมบูรณ์ (Full Academic Report)**](STEP_02_เล่มรายงานโครงงานฐานข้อมูลฉบับสมบูรณ์_Report.md) — รายงานทางการ 7 บทครบถ้วนตามใบงาน (หรือเปิดไฟล์ Word/PDF: `รายงาน_Mini_Project_Database_ร้านขาย_E-Book_2026.docx` / `.pdf`)
> 3. [**STEP_03: พจนานุกรมข้อมูลและการทดสอบระบบ (Data Dictionary & 8 Test Cases)**](STEP_03_พจนานุกรมข้อมูลและการทดสอบระบบ_DataDict_Tests.md) — รายละเอียด 9 ตาราง และกรณีทดสอบความถูกต้องของข้อมูล
> 4. [**STEP_04: คำสั่ง SQL วิเคราะห์รายงาน 4 ด้าน (Analytical Queries)**](STEP_04_คำสั่งSQLวิเคราะห์รายงาน4ด้าน_AnalyticalQueries.md) — สคริปต์คำสั่ง SQL ขั้นสูงพร้อมผลลัพธ์และคำอธิบายทางธุรกิจ
